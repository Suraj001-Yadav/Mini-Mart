...
// Add method-override middleware for this router
router.use(methodOverride('_method'));

// GET /order/:id - show order page for single product or cart
router.get('/order/:id?', auth, async (req, res) => {
  try {
    ...
    // If no productid query param, show cart order page
...
// POST /order - place order for single product or full cart
...
// POST /payment/:orderId - process payment

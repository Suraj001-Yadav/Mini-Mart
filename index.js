...
router.get('/Details', (req, res) => {
  res.render('Details'); // your contact form EJS page
});

// Contact Page (GET)
router.get('/contact', (req, res) => {
  res.render('contact'); // your contact form EJS page
});

router.get('/contactconfirm', (req, res) => {
  res.render('contactconfirm'); // your contact form EJS page
});

// Route to render the Medicine page
router.get('/medicine', async (req, res) => {
  try {
    const products = await Product.find({ category: 'medicine' }); // or however you're filtering
...
router.get('/Baby', async (req, res) => {
  try {
    const products = await Product.find({ category: 'baby-care' }); // or however you're filtering
...
router.get('/Officecat', async (req, res) => {
  try {
    const products = await Product.find({ category: 'office' }); // or however you're filtering
...
router.get('/Beauty', async (req, res) => {
  try {
    const products = await Product.find({ category: 'beauty' }); // or however you're filtering
...
router.get('/gardening', async (req, res) => {
  try {
    const products = await Product.find({ category: 'gardening' }); // or however you're filtering
...
router.get('/fruits', async (req, res) => {
  try {
    const products = await Product.find({ category: 'fruits' }); // or however you're filtering
...
router.get('/payment', (req, res) => {
  res.render('payment'); // your contact form EJS page
});

router.get('/paymentconf', (req, res) => {
  res.render('paymentconf'); // your contact form EJS page
});

router.get('/Myorder', (req, res) => {
  res.render('Myorder'); // your contact form EJS page
});

router.get('/profile', (req, res) => {
  res.render('profile'); // your contact form EJS page
});

router.get('/whislist', (req, res) => {
  res.render('whislist'); // your contact form EJS page
});

router.get('/Best', (req, res) => {
  res.render('Best'); // your contact form EJS page
});
...
router.get('/cart', (req, res) => {
  res.render('cart'); // your contact form EJS page
});
...
router.post('/contact', (req, res) => {
  // You can process and save form data here using req.body
...
//       // Find single product by id (populate or find directly from Product model)
//       const product = await Product.findById(req.query.productid);
//       return res.render('order', { product });
//     }
//     // Or show whole cart/order summary
//     const user = await User.findOne({ email: req.user.email }).populate('cart');
//     res.render('order', { cart: user.cart });
//   } catch (error) {
